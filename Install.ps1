...
{
    Write-Output "GreenBTC requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "GreenBTC blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/greenbtc"
Write-Output ""
Write-Output "Try the Quick Start Guide to running greenbtc-blockchain:"
Write-Output "https://github.com/greenbtc/greenbtc-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
