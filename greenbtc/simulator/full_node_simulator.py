...
from greenbtc.protocols.full_node_protocol import RespondBlock
...
from greenbtc.wallet.util.wallet_types import AmountWithPuzzlehash
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def process_blocks(self, count: int, farm_to: bytes32 = bytes32([0] * 32)) -> int:
        ...
        Consider `.farm_blocks()` or `.farm_rewards()` if the goal is to receive GBTC at
        an address.
