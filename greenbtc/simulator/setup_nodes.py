...
from greenbtc.simulator.block_tools import BlockTools, create_block_tools_async
...
) -> AsyncIterator[Tuple[FullNodeAPI, FullNodeAPI, GreenBTCServer, GreenBTCServer, BlockTools]]:
    """
...
) -> AsyncIterator[Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, GreenBTCServer]], BlockTools]]:
    with TempKeyring(populate=True) as keychain1, TempKeyring(populate=True) as keychain2:
