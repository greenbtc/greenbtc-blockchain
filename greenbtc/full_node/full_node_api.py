...
from greenbtc.util.api_decorators import api_request, bytes_required, execute_task, peer_required, reply_type
from greenbtc.util.generator_tools import get_block_header
    ...
    async def declare_proof_of_space(
        ...
        async with self.full_node.timelord_lock:
            ...
            if prev_b is not None:
                ...
                height = uint32(0)
            self.log.info(f"[debug] creating block {height} {difficulty_coefficient}")
