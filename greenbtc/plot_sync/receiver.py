...
from greenbtc.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR, _expected_plot_size
from greenbtc.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from greenbtc.plot_sync.exceptions import (
...
from greenbtc.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from greenbtc.plotting.util import HarvestingMode
...
from greenbtc.server.outbound_message import make_msg
...
from greenbtc.util.ints import int16, uint32, uint64
from greenbtc.util.misc import get_list_or_len
...
class Receiver:
    _connection: WSGreenBTCConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSGreenBTCConnection:
