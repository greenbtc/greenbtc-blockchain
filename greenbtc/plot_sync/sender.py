...
from greenbtc.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from greenbtc.plot_sync.util import Constants
from greenbtc.plotting.manager import PlotManager
from greenbtc.plotting.util import PlotInfo
...
from greenbtc.server.ws_connection import NodeType, ProtocolMessageTypes, WSGreenBTCConnection, make_msg
from greenbtc.util.generator_tools import list_to_batches
...
class Sender:
    ...
    _connection: Optional[WSGreenBTCConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSGreenBTCConnection) -> None:
