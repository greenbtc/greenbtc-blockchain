...
from greenbtc.protocols.protocol_timing import INVALID_PROTOCOL_BAN_SECONDS
...
from greenbtc.server.ws_connection import ConnectionCallback, WSGreenBTCConnection
...
from greenbtc.util.network import WebServer, is_in_network, is_localhost, is_trusted_peer
...
class GreenBTCServer:
    ...
    all_connections: Dict[bytes32, WSGreenBTCConnection] = field(default_factory=dict)
    ...
    def create(
        ...
        if local_type in authenticated_client_types:
            ...
            ssl_client_context = ssl_context_for_client(
                ca_cert=greenbtc_ca_crt_path,
                ca_key=greenbtc_ca_key_path,
    ...
    async def incoming_connection(self, request: web.Request) -> web.StreamResponse:
        ...
        try:
            connection = WSGreenBTCConnection.create(
    ...
    async def connection_added(
        self, connection: WSGreenBTCConnection, on_connect: Optional[ConnectionCallback] = None
    ) -> None:
    ...
    def connection_closed(self, connection: WSGreenBTCConnection, ban_time: int, closed_connection: bool = False) -> None:
    ...
    def is_trusted_peer(self, peer: WSGreenBTCConnection, trusted_peers: Dict[str, Any]) -> bool:
