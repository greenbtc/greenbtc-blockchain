...
from greenbtc.daemon.server import service_launch_lock_path, singleton
...
from greenbtc.rpc.rpc_server import start_rpc_server
...
class Service:
    def __init__(
        ...
        proctitle_name = f"greenbtc_{service_name}"
