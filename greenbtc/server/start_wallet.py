...
from greenbtc.rpc.wallet_rpc_api import WalletRpcApi
...
from greenbtc.util.config import get_unresolved_peer_infos, load_config, load_config_cli
...
from greenbtc.util.task_timing import maybe_manage_task_instrumentation
...
async def async_main() -> int:
    ...
    if local_test is True:
        from greenbtc.simulator.block_tools import test_constants
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("GREENBTC_INSTRUMENT_WALLET") is not None):
