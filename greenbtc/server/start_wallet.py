...
from greenbtc.util.config import load_config_cli, load_config
...
def main() -> int:
    freeze_support()
    if os.getenv("GREENBTC_INSTRUMENT_WALLET", 0) != 0:
        from greenbtc.util.task_timing import start_task_instrumentation, stop_task_instrumentation
        import atexit
