...
from greenbtc.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from greenbtc.timelord.timelord_state import LastState
from greenbtc.timelord.types import Chain, IterationType, StateType
...
from greenbtc.util.config import process_config_start_method
...
class Timelord:
    ...
    def __init__(self, root_path: Path, config: Dict[str, Any], constants: ConsensusConstants) -> None:
        ...
        self._server: Optional[GreenBTCServer] = None
    ...
    def _can_infuse_unfinished_block(self, block: timelord_protocol.NewUnfinishedBlockTimelord) -> Optional[uint64]:
        ...
        proof_of_stake = block.proof_of_stake
        try:
