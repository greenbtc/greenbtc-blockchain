...
@click.option("-f", "--fingerprint", help="Set the fingerprint to specify which wallet to use", type=int)
@click.option("-i", "--id", help="Id of the wallet to use", type=int, default=1, show_default=True, required=True)
@click.option("-a", "--amount", help="How much greenbtc to send, in SIT", type=str, required=True)
@click.option(
    "-m",
    "--fee",
...
@wallet_cmd.command("send_from", short_help="Transfer all greenbtc away from a specific puzzle hash")
@click.option(
    "-p",
    "--rpc-port",
    help=(
...
@click.option(
    "--launcher-hash",
    help="Set the launcher hash, you should get it from greenbtc wallet",
    type=str,
    default=None,
)
@click.option("-f", "--fingerprint", help="Set the fingerprint to specify which wallet to use", type=int)
