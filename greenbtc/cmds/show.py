...
def show_cmd(
    ...
    if connections:
        print("'greenbtc show -c' has been renamed to 'greenbtc peer -c' ")
    if add_connection != "":
        print("'greenbtc show -a' has been renamed to 'greenbtc peer -a' ")
    if remove_connection != "":
        print("'greenbtc show -r' has been renamed to 'greenbtc peer -r' ")
