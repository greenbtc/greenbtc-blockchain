...
from greenbtc.util.keychain import set_keys_root_path, supports_keyring_passphrase
...
@click.group(
    help=f"\n  Manage greenbtc blockchain infrastructure ({DIST_NAME} {__version__})\n",
...
@cli.command("version", short_help="Show greenbtc version")
def version_cmd() -> None:
    print(DIST_NAME, __version__)


@cli.command("run_daemon", short_help="Runs greenbtc daemon")
@click.option(
    "--wait-for-unlock",
