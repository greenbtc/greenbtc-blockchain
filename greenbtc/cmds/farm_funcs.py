...
from greenbtc.util.misc import format_bytes, format_minutes
...
async def summary(
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'greenbtc start wallet' and 'greenbtc wallet show'")
