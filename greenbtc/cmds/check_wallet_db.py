...
from greenbtc.util.collection import find_duplicates
...
from greenbtc.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in GreenBTC wallet databases.
    The core greenbtc client currently uses sqlite to store the wallet databases, one database per key.
\b
