...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(greenbtc complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mgreenbtc complete generate > ~/.greenbtc-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.greenbtc-complete-bash\033[0m
    """
    ...
    subprocess.run(["greenbtc"], check=True, env={**os.environ, "_GREENBTC_COMPLETE": f"{shell}_source"})
