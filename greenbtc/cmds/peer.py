...
from greenbtc.cmds.cmds_util import NODE_TYPES
from greenbtc.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified GreenBTC service to ip:port", type=str, default="")
@click.option(
