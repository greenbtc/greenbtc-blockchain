...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("GreenBTC Signed Message", message)) using the
    ...
    # Standard BLS signatures used by GreenBTC use the BLS message augmentation scheme
