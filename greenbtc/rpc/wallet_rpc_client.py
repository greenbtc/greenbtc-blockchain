...
from greenbtc.data_layer.data_layer_wallet import Mirror, SingletonRecord
from greenbtc.pools.pool_wallet_info import PoolWalletInfo
...
from greenbtc.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
from greenbtc.wallet.util.query_filter import TransactionTypeFilter
...
from greenbtc.wallet.vc_wallet.vc_store import VCRecord
...
class WalletRpcClient(RpcClient):
    """
    Client to GreenBTC RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        gbtc_coins: Optional[List[Dict]] = None,
        gbtc_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "gbtc_change_target": gbtc_change_target,
