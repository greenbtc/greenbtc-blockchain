...
total_greenbtc = 0
print("Pool address: ")
total_greenbtc += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_greenbtc += make_puzzle(farmer_amounts)

assert total_greenbtc == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
