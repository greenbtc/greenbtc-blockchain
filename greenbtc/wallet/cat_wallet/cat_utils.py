...
from greenbtc.types.spend_bundle import CoinSpend, SpendBundle
...
from greenbtc.wallet.puzzles.cat_loader import CAT_MOD
...
def next_info_for_spendable_cat(spendable_cat: SpendableCAT) -> Program:
    ...
    # https://github.com/greenbtc/clvm/pull/102
