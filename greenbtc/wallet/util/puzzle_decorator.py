...
from greenbtc.wallet.puzzles.clawback.puzzle_decorator import ClawbackPuzzleDecorator
from greenbtc.wallet.puzzles.stake.puzzle_decorator import StakePuzzleDecorator
