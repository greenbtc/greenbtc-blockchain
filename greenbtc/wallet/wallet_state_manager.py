...
from greenbtc.consensus.coinbase import farmer_parent_id, pool_parent_id, create_puzzlehash_for_pk
...
from greenbtc.protocols.wallet_protocol import CoinState, NewPeakWallet
