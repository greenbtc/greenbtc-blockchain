...
from greenbtc.wallet.cat_wallet.cat_utils import CAT_MOD, construct_cat_puzzle
...
from greenbtc.wallet.puzzles.singleton_top_layer_v1_1 import SINGLETON_LAUNCHER_HASH, SINGLETON_MOD_HASH
from greenbtc.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from greenbtc.wallet.util.curry_and_treehash import curry_and_treehash
from greenbtc.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="greenbtc.wallet.vc_wallet.cr_puzzles",
