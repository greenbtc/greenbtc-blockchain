...
from greenbtc.protocols.wallet_protocol import PuzzleSolutionResponse
...
from greenbtc.wallet.cc_wallet.cc_info import CCInfo
from greenbtc.wallet.cc_wallet.cc_utils import (
    CC_MOD,
    SpendableCC,
...
from greenbtc.wallet.puzzles.genesis_by_coin_id_with_0 import (
