...
from greenbtc.plotting.util import PlotInfo, parse_plot_info
from greenbtc.protocols import harvester_protocol
from greenbtc.protocols.farmer_protocol import FarmingInfo
from greenbtc.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSGreenBTCConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSGreenBTCConnection
    ):
        """
