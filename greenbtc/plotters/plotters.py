...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, greenbtc_plotter_options, "chiapos", "Create a plot with the default greenbtc plotter")
    ...
    deprecation_warning_bb2 = "[DEPRECATED] 'greenbtc plotters bladebit2' was integrated to 'greenbtc plotters bladebit'"
