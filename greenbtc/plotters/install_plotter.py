import os
from greenbtc.plotters.bladebit import install_bladebit
from greenbtc.plotters.madmax import install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        ...
        if not os.path.exists(root_path / "madmax-plotter/build/greenbtc_plot"):
