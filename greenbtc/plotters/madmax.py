...
from greenbtc.plotters.plotters_util import get_venv_bin, reset_loop_policy_for_windows, run_command, run_plotter
from greenbtc.plotting.create_plots import resolve_plot_keys
...
def plot_madmax(args, greenbtc_root_path: Path, plotters_root_path: Path):
    ...
    try:
        asyncio.run(run_plotter(greenbtc_root_path, args.plotter, call_args, progress))
    except Exception as e:
