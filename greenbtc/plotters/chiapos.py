"""
NOTE: This contains duplicate code from `greenbtc.cmds.plots`.
After `greenbtc plots create` becomes obsolete, consider removing it from there.
"""
...
from greenbtc.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "GreenBTC Proof of Space", "version": chiapos_version, "installed": True}


def plot_greenbtc(args: Namespace, root_path: Path) -> None:
    try:
