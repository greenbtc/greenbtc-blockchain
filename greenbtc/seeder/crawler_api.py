...
class CrawlerAPI:
    ...
    @api_request(peer_required=True)
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSGreenBTCConnection) -> Optional[Message]:
    ...
    async def new_compact_vdf(
        self, request: full_node_protocol.NewCompactVDF, peer: WSGreenBTCConnection
    ) -> Optional[Message]:
        pass
