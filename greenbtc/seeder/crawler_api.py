...
from greenbtc.protocols import full_node_protocol, wallet_protocol
...
class CrawlerAPI:
    ...
    @peer_required
    @api_request
    async def request_peers(self, _request: full_node_protocol.RequestPeers, peer: ws.WSGreenBTCConnection):
        pass
    ...
    @peer_required
    @api_request
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: ws.WSGreenBTCConnection) -> Optional[Message]:
    ...
    @peer_required
    @api_request
    async def new_compact_vdf(self, request: full_node_protocol.NewCompactVDF, peer: ws.WSGreenBTCConnection):
        pass
