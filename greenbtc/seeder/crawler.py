...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: WSGreenBTCConnection):
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSGreenBTCConnection):
        try:
            peer_info = peer.get_peer_info()
    ...
    async def on_connect(self, connection: WSGreenBTCConnection):
        pass
