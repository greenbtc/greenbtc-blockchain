...
from greenbtc.consensus.difficulty_adjustment import can_finish_sub_and_full_epoch
from greenbtc.consensus.get_block_challenge import final_eos_is_already_included, get_block_challenge
from greenbtc.consensus.make_sub_epoch_summary import make_sub_epoch_summary
...
from greenbtc.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot, SubSlotProofs
...
def validate_unfinished_header_block(
    ...
    required_iters: uint64 = calculate_iterations_quality(
        ...
        expected_difficulty,
        cc_sp_hash,
        header_block.proof_of_stake.coefficient,
    )
