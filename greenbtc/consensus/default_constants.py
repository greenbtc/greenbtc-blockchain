...
DEFAULT_CONSTANTS = ConsensusConstants(
    ...
    DIFFICULTY_STARTING=uint64(128),
    ...
    # Forks of greenbtc should change this value to provide replay attack protection. This is set to mainnet genesis chall
    AGG_SIG_ME_ADDITIONAL_DATA=bytes.fromhex("b8aae2dac69218331178a63bd89dd44c275ff199ca11bfd54d928a23e0682388"),
    ...
    HARD_FORK2_HEIGHT=uint32(2000000),
    # June 2024
