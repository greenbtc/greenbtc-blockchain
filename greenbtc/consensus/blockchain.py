    ...
    async def get_farmer_difficulty_coefficient(
        ...
        if minimal_staking != 0 and staking >= minimal_staking:
            if blocks == 0 or network_space == 0:
                ...
                coefficient = min_coefficient + Decimal(1) / (Decimal(staking) / space + 1)
            else:
                coefficient = min_coefficient + Decimal(1) / (Decimal(staking) / space + Decimal("0.5"))
