...
from greenbtc.pools.pool_config import PoolWalletConfig, load_pool_config
...
from greenbtc.util.config import config_path_for_filename, load_config, save_config
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'greenbtc keys generate' or open the UI."
