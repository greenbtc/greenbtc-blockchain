...
root = here.parent
cache_path = root.joinpath(".greenbtc_cache", "manage_clvm.json")
...
from greenbtc.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"greenbtc"}
hashes_path = root.joinpath("greenbtc/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("greenbtc/wallet/puzzles")
...
main(auto_envvar_prefix="GREENBTC_MANAGE_CLVM")
