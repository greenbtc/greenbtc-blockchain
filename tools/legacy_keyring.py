"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of greenbtc-blockchain. To use this
...
from greenbtc.util.errors import KeychainUserNotFound
from greenbtc.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-greenbtc-{CURRENT_KEY_VERSION}"  # e.g. user-greenbtc-1.8
DEFAULT_SERVICE = f"greenbtc-{DEFAULT_USER}"  # e.g. greenbtc-user-greenbtc-1.8
MAX_KEYS = 100
