...
from greenbtc.simulator.block_tools import make_unfinished_block
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        greenbtc_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            full_node.set_server(cast(GreenBTCServer, FakeServer()))
            ...
            peer: WSGreenBTCConnection = cast(WSGreenBTCConnection, FakePeer())
...
async def run_sync_checkpoint(
    ...
    greenbtc_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
    ...
    try:
        ...
        peer: WSGreenBTCConnection = FakePeer()  # type: ignore[assignment]
