...
"""
run_block: Convert an encoded FullBlock from the GreenBTC blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../greenbtc/types/full_block.py) in json format
...
$ca_root is the directory containing your current GreenBTC config files
$hash is the header_hash of the [BlockRecord](../greenbtc/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../greenbtc/types/condition_opcodes.py)
...
from greenbtc.wallet.cat_wallet.cat_utils import match_cat_puzzle
...
DESERIALIZE_MOD = load_serialized_clvm_maybe_recompile(
    "chialisp_deserialisation.clvm", package_or_requirement="greenbtc.wallet.puzzles"
)
