...
if [ "$NOTARIZE" == true ]; then
  ...
  notarize-cli --file="$DMG_NAME" --bundle-id net.greenbtc.blockchain \
...
# xcrun altool --notarize-app -f GreenBTC-0.1.X.dmg --primary-bundle-id net.greenbtc.blockchain -u username -p password
