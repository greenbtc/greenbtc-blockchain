...
Write-Output "Remove unused @greenbtc packages to make cache slim"
...
# Remove `packages/gui/node_modules/@greenbtc` because it causes an error on later `electron-packager` command
Remove-Item "@greenbtc" -Recurse -Force
