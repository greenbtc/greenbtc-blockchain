...
rm -rf ../venv || true
rm -rf venv || true
rm -rf greenbtc_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf greenbtc-blockchain-gui/build || true
rm -rf greenbtc-blockchain-gui/daemon || true
rm -rf greenbtc-blockchain-gui/node_modules || true
rm greenbtc-blockchain-gui/temp.json || true
( cd "$PWD/greenbtc-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
