...
APP_VERSION=$1
APP_BUNDLEID="net.greenbtc.blockchain"
APP_NAME="SIT"
...
#   --hardened-runtime=true --provisioning-profile=greenbtcblockchain.provisionprofile \
...
# notarize-cli --file=$DMG_NAME.dmg --bundle-id net.greenbtc.blockchain --username "williejonagvio38@gmail.com" --password "mrdo-yfcr-intb-eyxr"
