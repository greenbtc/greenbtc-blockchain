...
Write-Output "   ---"
Write-Output "Build greenbtc-blockchain wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install greenbtc-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install greenbtc-blockchain"
pip install --no-index --find-links=.\win_build\ greenbtc-blockchain
...
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\greenbtc-blockchain-gui\" -Recurse
